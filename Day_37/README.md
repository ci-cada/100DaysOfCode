...
I decided to do the day 6 of my JS Coding Journey Tests.

Later I joined in the fun with python. Took some lectures on Jenny's Lectures in youtube on python and gained some theoritical knowledge on creating a cypher and the hangman game. Never tried the code to the two but I will after I know that I have grasped the concepts very well.
