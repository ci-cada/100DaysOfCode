...
In Depth Functions and completion on Loops tasks. 
...
These exercises were a bunch to start and complete after leearning functions so I skipaddled them to the next day to focus on loops and arrays in JS since I could not yet master the concepts well.


**Python Programming** 

Well I do not fully understand the concept of of tkinter so I kept on googling and learning but I still could not get it so I did not give up but skipped to focus on things that I understood. 

I will start a tkinter repo to learn each and every concept and eventually build my own application.
